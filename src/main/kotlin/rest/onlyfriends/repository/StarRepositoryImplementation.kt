...
class StarRepositoryImplementation: StarRepository {
    override val stars: Map<Int, List<Star>>
        get() = TODO("Not yet implemented")
    override val page1: List<Star>
        get() = TODO("Not yet implemented")
    override val page2: List<Star>
        get() = TODO("Not yet implemented")
    override val page3: List<Star>
        get() = TODO("Not yet implemented")
    override val page4: List<Star>
        get() = TODO("Not yet implemented")
    override val page5: List<Star>
        get() = TODO("Not yet implemented")
